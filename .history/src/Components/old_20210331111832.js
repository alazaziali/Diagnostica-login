...
const Login = (props) => {
  ...
  const passwordVisibility = () => {
    ...
    setElement({ showPassword: !showpassword });
  }
  ...
  const handleEmail = text => {
    const readEmail = text.target.value;

    setElement({ ...state, email: readEmail });
  }

  const handlePassword = text => {
    const readPass = text.target.value;
    setElement({ ...state, password: readPass });
  }

  const login = () => {
    console.log("Done", handlePassword.text, handleEmail.text);
    // let checkIn = {}
    // checkIn.email = this.state.email
    // checkIn.password = this.state.password
